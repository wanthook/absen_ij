...
//                        $('#loadingDialog').modal('show');
            ...
            dTableKar = $('#dTableKar').DataTable({
                ...
                },
                {
                    ...
                    "className":      'dtsTanggal',
                    "orderable":      false,
                    "data" : 'tanggal',
                    "render"     :   function(data, type, row, meta)
                    {
                        return '<input type="text" class="form-control form-control-sm" name="dtsTanggal[]" value="'+row.tanggal+'">';
                    },
                },
                {
                    targets : 'ttanggalakhir',
                    data : 'tanggal_akhir',
                    "className":      'dtsTanggalAkhir',
                    "orderable":      false,
                    "render"     :   function(data, type, row, meta)
                    {
                        return '<input type="text" class="form-control form-control-sm" name="dtsTanggalAkhir[]" value="'+row.tanggal_akhir+'">';
                    },
                },
                {
                    targets : 'tpin',
                    ...
                    "render"     :   function(data, type, row, meta)
                    {
                        return '<select class="form-control form-control-sm select2" name="dtsPin[]"><option value="'+row.+'">'++'</optiom></select>';
                    },
                },
                {
                        targets : 'tnik',
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" data-target-input="nearest">
                                            {{ Form::text('sTanggal', \Carbon\Carbon::now()->toDateString(), ['id' => 'sTanggal', 'class' => 'form-control form-control-sm', 'placeholder' => 'Tanggal Alasan']) }}
