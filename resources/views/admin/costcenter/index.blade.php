...
@section('title_page')
<p>Master Cost Center</p>
@endsection


@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Beranda</a></li>
<li class="breadcrumb-item active">Master Cost Center</li>
@endsection
...
<div class="modal fade" id="modal-form">
    <div class="modal-dialog">
        <div class="modal-content bg-secondary">
            ...
            <h4 class="modal-title">Form Cost Center</h4>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
            </button>
        </div>
        <form id="form_data" action="{{route('savecostcenter')}}" accept-charset="UTF-8" >
            {{csrf_field()}}
            <input type="hidden" name="id" id="id">
        <div class="modal-body">            
                
                <div class="form-group">
                    <label for="kode">Kode Cost Center</label>
                    <input type="text" class="form-control" id="kode" name="kode" placeholder="Kode Cost Center">
                </div>
                <div class="form-group">
                    <label for="kode">Deskripsi Cost Center</label>
                    <input type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="Deskripsi Cost Center">
                </div>
        </div>
