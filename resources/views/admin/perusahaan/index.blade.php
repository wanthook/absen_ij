        ...
        $(function(e)
        {
            ...
            dTable = $('#dTable').DataTable({
                ...
                [
                    ...
                    { data    : "pin_min", name : "pin_min" },
                    { data    : "pin_max", name : "pin_max" },
                ...
                "drawCallback": function( settings, json ) 
                {
                    ...
                    $('.editrow').on('click',function(e)
                    {
                        ...
                        $('#pin_min').val(datas.pin_min);
                        $('#pin_max').val(datas.pin_max);
                    });
...
<div class="modal fade" id="modal-form">
    <div class="modal-dialog">
        ...
        <form id="form_data" action="{{route('saveperusahaan')}}" accept-charset="UTF-8" >
            {{csrf_field()}}
        ...
        <div class="modal-body">            
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kode" name="kode" placeholder="Kode Perusahaan">
                </div>
                <div class="form-group">
                    <label for="nama">Nama Perusahaan</label>
                    <input type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="Nama Perusahaan">
                </div>            
                <div class="form-group">
                    <label for="pin_min">PIN Min</label>
                    <input type="text" class="form-control" id="pin_min" name="pin_min" placeholder="PIN Min">
                </div>
                <div class="form-group">
                    <label for="pin_out">PIN Max</label>
                    <input type="text" class="form-control" id="pin_max" name="pin_max" placeholder="PIN Max">
                </div>
        </div>
