...
@section('title_page')
<p>Laporan Absen Detail</p>
@endsection


@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Beranda</a></li>
<li class="breadcrumb-item active">Laporan Absen Detail</li>
@endsection
...
@section('content')
{{ Form::open(['route' => ['detaillaporan'], 'id' => 'form_data', 'target' => '_blank']) }}
