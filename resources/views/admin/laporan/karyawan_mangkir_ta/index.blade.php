...
@section('title_page')
<p>Laporan Karyawan Mangkir/TA</p>
@endsection


@section('breadcrumb')
<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Beranda</a></li>
<li class="breadcrumb-item active">Laporan Karyawan Mangkir/TA</li>
@endsection
...
@section('content')
{{ Form::open(['route' => ['karyawanmangkirtalaporan'], 'id' => 'form_data', 'target' => '_blank']) }}
