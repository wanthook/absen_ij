...
class ProsesabsenController extends Controller
{
    ...
    //                        dd($arrProses);
                    ...
                    if($jadwal->tipe == 'D')
                    {
                        $jadwalArr = $this->jadwalDay($tanggal, $jadwal);
                    }
                    else
                    {
                        $jadwalArr = $this->jadwalShift($tanggal, $jadwal);
                    }
...
//                            }
                            ...
                            $arrProses = array(
                                ...
                                'alasan_id' => $alasanId,
                                'tanggal' => $key,
                                'jam_masuk' => ($jMasuk)?$jMasuk->format('H:i:s'):null,
                                'jam_keluar' => ($jKeluar)?$jKeluar->format('H:i:s'):null,
                                ...
                                'n_masuk' => ($nMasuk)?$nMasuk:null,
                                'n_keluar' => ($nKeluar)?$nKeluar:null,
                                'libur' => $isLibur,
                                ...
                                'shift3' => ($shift3)?$shift3:null,
                                'gp' => $nilaiGp,
                                'jumlah_jam_kerja' => ($jumlahJamKerja)?$jumlahJamKerja:null,
